# TODOs Archive — Q1–Q5 Audit Remediation (2026-05-24 deep audit)

Archived 2026-06-20. These five segments are **100% closed**
(Q1=25 / Q2=32 / Q3=40 / Q4=7 / Q5=4 DONE, 0 TODO) and were swept out of
the live `TODOs.md` per its maintenance convention (entirely-closed segments
are externalized in batches). Source audit: `docs/audit/` (16 per-crate
reports + README). The live queue retains only the H and P-A backlogs.
