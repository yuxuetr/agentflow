# TODOs Archive — Closed P-Segments (2026-05-20 snapshot)

Snapshot of the P0 / P1 / P2 / P3 / P4 / P5 / P6 / P7 / P-H / P9 /
P-LLM / M segments — all closed as of the 2026-05-19 project
evaluation — moved out of the active `TODOs.md` on 2026-05-20 to
keep that file focused on the live P10 optimization backlog and
the small "Recently Closed" tail.

Every entry below is `DONE` or `DEFERRED`. For the still-active
work, see the active `TODOs.md` (P10 segment) and the most recent
evaluation at `docs/archive/PROJECT_EVALUATION_2026-05-19.md`.

For earlier archives, see:
- [`TODOs-archive-2026-05-09-n1-n10.md`](TODOs-archive-2026-05-09-n1-n10.md) — N-series execution plan (closed)
- [`TODOs-archive-2026-05-10-p0-p4.md`](TODOs-archive-2026-05-10-p0-p4.md) — early P-series execution plan (closed)
- [`TODOs-archive-2026-05-19-recently-closed.md`](TODOs-archive-2026-05-19-recently-closed.md) — Recently-Closed entries swept on 2026-05-19
