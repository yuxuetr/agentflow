...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("============================================================\n");
    println!("This demo shows the correct API patterns and request structures for each StepFun model type.");
...
async fn demo_text_models(_api_key: &str) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   Request body: {}", serde_json::to_string_pretty(&non_streaming_request)?);
    ...
    println!("   Endpoint: POST /v1/chat/completions");
    println!("   Request body: {}", serde_json::to_string_pretty(&streaming_request)?);
...
async fn demo_image_understanding(_api_key: &str) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   Endpoint: POST /v1/chat/completions");
    println!("   Request body: {}", serde_json::to_string_pretty(&vision_request)?);
...
async fn demo_multimodal(_api_key: &str) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   Endpoint: POST /v1/chat/completions");
    println!("   Request body: {}", serde_json::to_string_pretty(&multimodal_request)?);
...
async fn demo_text_to_speech(_api_key: &str) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   Request body: {}", serde_json::to_string_pretty(&tts_request)?);
...
async fn demo_image_generation(_api_key: &str) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   Request body: {}", serde_json::to_string_pretty(&image_request)?);
...
async fn demo_voice_cloning(_api_key: &str) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   Request body: {}", serde_json::to_string_pretty(&voice_request)?);
    ...
    println!("   Endpoint: POST /v1/audio/speech");
    println!("   Request body: {}", serde_json::to_string_pretty(&tts_with_clone)?);
