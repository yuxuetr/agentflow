...
pub fn detect_file_type(path: &Path) -> Result<String> {
  ...
  match extension.as_str() {
    ...
    | "swift" | "kt" | "scala" | "clj" | "hs" | "ml" | "fs" | "elm" | "dart" | "r" | "sql"
    | "sh" | "bash" | "zsh" | "fish" | "ps1" | "bat" | "cmd" => Ok("text".to_string()),
    ...
    // Audio files
    "mp3" | "wav" | "flac" | "aac" | "ogg" | "m4a" | "wma" | "opus" => Ok("audio".to_string()),

    // Video files
    "mp4" | "avi" | "mkv" | "mov" | "wmv" | "flv" | "webm" | "m4v" => Ok("video".to_string()),
