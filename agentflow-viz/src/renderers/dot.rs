...
mod tests {
    ...
    fn test_escape_special_characters() {
        ...
        assert_eq!(DotRenderer::escape_label("Say \"Hello\""), "Say \\\"Hello\\\"");
    }

    #[test]
    fn test_node_shapes() {
        assert_eq!(DotRenderer::node_shape(&VisualNodeType::Standard), "box");
        assert_eq!(DotRenderer::node_shape(&VisualNodeType::While { max_iterations: 10 }), "diamond");
        assert_eq!(DotRenderer::node_shape(&VisualNodeType::Map { parallel: true }), "folder");
