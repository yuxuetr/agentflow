...
//     them explicitly.
// Swap these for real render tests if that coverage gap ever matters —
// the public contract under test is identical either way.
...
describe('ErrorBoundary', () => {
  ...
  it('fallback renders an alert role and the error message', () => {
  ...
  it('reset clears the captured error so children render again', () => {
  ...
  it('label prop appears in the fallback heading', () => {
