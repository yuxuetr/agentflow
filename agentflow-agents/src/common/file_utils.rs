...
pub async fn save_content<P: AsRef<Path>>(file_path: P, content: &str) -> crate::AgentResult<()> {
...
pub async fn load_content<P: AsRef<Path>>(file_path: P) -> crate::AgentResult<String> {
